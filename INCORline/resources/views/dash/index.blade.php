...
<div>
    ...
    <div class="bg-blue-900 md:overflow-hidden">
      <div class="px-4 py-20 md:py-4">
        <div class="md:max-w-6xl md:mx-auto">
          <div class="md:flex md:flex-wrap">
            <div class="md:w-1/2 text-center md:text-left md:pt-16">
              <h3 class="font-bold text-white text-2xl md:text-5xl leading-tight mb-4">
                Software para el control de crecimiento de los niños de 0 a 5 años
              </h3>
              ...
              <img src="{{asset('/img/incorokpng.png')}}" style="width: 40%; margin: 8% 25%;" alt="">
              {{-- <a
                href="#"
